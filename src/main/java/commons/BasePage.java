...
public class BasePage {
    ...
    public void clearDataTextbox(WebDriver driver, String locator) {
        ...
        WebElement textboxElement = getWebElement(driver, locator);
        if (os.contains("mac")) {
            textboxElement.sendKeys(Keys.COMMAND + "a");
        } else {
            textboxElement.sendKeys(Keys.CONTROL + "a");
        }
        textboxElement.sendKeys(Keys.DELETE);       // Xóa

        // cmt đoạn này lại vì clear rồi nhưng sendkey nó lại mặc định có giá trị cũ
//		getWebElement(driver, locator).clear();
     ...
     */
    public void selectItemInCustomDropdown(WebDriver driver, String dropdowLocation, String itemLocator, String valueExpectedItem) {
