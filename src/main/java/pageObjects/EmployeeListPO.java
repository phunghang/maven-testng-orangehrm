...
public class EmployeeListPO extends BaseActions {
    ...
    public PersonalDetailPO clickToPersonalDetailById(String employeeId) {
        enterToEmployeeIdSearchTextbox(employeeId);
        clickToSearchBt();
        waitIconLoadingInvisible();
        clickToElement(driver, EmployeeListUI.EMPLOYEE_LIST_ROW);
        waitIconLoadingInvisible();
        return PageGeneratorManager.getPersonalDetailPO(driver);
